...
int main() {
	...
	cout << ptr->name << " " << structure.id << " " << structure.money <<"만원" << endl;
	cout << ptr->pNext->name << " " << struct2.id << " "<< struct2.money <<"만원" << endl;
	cout << ptr2->pNext->name << " " << struct3.id << " " << struct3.money << "만원" << endl;
	cout << ptr3->pNext->name << " " << struct4.id << " " << struct4.money << "만원" << endl;
